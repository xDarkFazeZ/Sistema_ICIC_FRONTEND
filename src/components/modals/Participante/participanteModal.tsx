              ...
              <div className="pt-2 border-t border-default-200">
                ...
                <div className="space-y-1 max-h-28 overflow-y-auto">
                  {cursosAnteriores.map((ins: any) => (
                    <div
                      key={ins.id}
                      className="flex items-center justify-between text-xs px-2 py-1 rounded-lg bg-white dark:bg-default-700 border border-default-100"
                    >
...
export default function ParticipanteModal({
  ...
  const inputCN = {
    inputWrapper: [
      ...
      "data-[hover=true]:border-indigo-300 dark:data-[hover=true]:border-indigo-500",
      "data-[focus=true]:border-indigo-500 dark:data-[focus=true]:border-indigo-400",
      "data-[focus=true]:shadow-md data-[focus=true]:shadow-indigo-100/60 dark:data-[focus=true]:shadow-indigo-900/40",
  ...
  const acInp = {
    classNames: {
      inputWrapper: [
        ...
        "data-[hover=true]:border-indigo-300 dark:data-[hover=true]:border-indigo-500",
        "data-[focus=true]:border-indigo-500 dark:data-[focus=true]:border-indigo-400",
        "data-[focus=true]:shadow-md",
        "data-[invalid=true]:border-rose-400",
      ].join(" "),
      label: "text-slate-500 dark:text-slate-400 text-xs font-medium",
      input: "text-slate-800 dark:text-slate-100 text-sm font-medium",
    },
  };
