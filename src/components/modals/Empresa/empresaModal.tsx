      ...
      <div className="space-y-5 px-1">
        ...
        <div className="space-y-4">
          ...
          <Input
            ...
            maxLength={100}
            startContent={<BuildingOffice2Icon className="w-4 h-4 text-default-400 shrink-0" />}
            isRequired
          />
          ...
          <Input
            ...
            maxLength={200}
            startContent={<MapPinIcon className="w-4 h-4 text-default-400 shrink-0" />}
            isRequired
          />
        </div>
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <Input
              ...
              startContent={<EnvelopeIcon className="w-4 h-4 text-default-400 shrink-0" />}
            />
          </div>
        </div>
