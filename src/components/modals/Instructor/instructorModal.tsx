...
// ✅ ID único para el form del instructor — no colisiona con "modal-form" del curso
...
export default function InstructorModal({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault(); // ← evitar que propague al form del curso
  ...
  return (
    <ModalForm
      ...
      formId={FORM_ID} // ✅ ID único — no colisiona con el modal de curso
    >
      {/* ✅ El form tiene su propio id único */}
